...
const projects = [
  ...
  {
    name: "Sound Pillars Model",
    description:
      "Real Time Animated 3D visual model (via code) created from scratch using Blender and imported through Three.js. Beautiful sound pillars move across the browser scene, highly optimized and customizable through a coded GUI component. Click on the icon to explore my live deployed demo. ",
    tags: [
      {
        name: "JavaScript",
        color: "text-yellow-400",
