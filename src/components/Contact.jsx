...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!form.message || !form.email || !form.name) {
      ...
      setAlertType("error");
      setAlertText(
        "Please fill out all input values such as your name, email, and message body completely",
      );
      setShowAlert(true);
    ...
    emailjs
      ...
      .then(
        () => {
          ...
          setAlertText(
            `Thank you ${form.name}, I will get back to your message as soon as possible!`,
          );
          setShowAlert(true);
          setForm({
            name: "",
        ...
        (error) => {
          ...
          setAlertType("error");
          setAlertText(
            "Something went wrong, please make sure you are inputting correct email endings and/or name and message. Otherwise please email contact@jesusperez.dev manually to report any issues",
          );
          setShowAlert(true);
          console.log(error);
        },
