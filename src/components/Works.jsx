    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.78)}>
      ...
      >
        ...
        <div className="mt-5 flex-grow">
          ...
          <p className="mt-2 mt-2 text-secondary text-[12px] flex-grow">
            {" "}
            {description}{" "}
          </p>
        </div>
    ...
    <div>
      ...
      <div className="w-full flex">
        ...
        >
          ...
          It reflects my ability to solve client's/people's problems, work with
          various tech stacks, collaborate with people, and manage projects
          efficiently.
        </motion.p>
      </div>
