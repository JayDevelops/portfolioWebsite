...
const ProjectCard = ({
  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.78)}>
      <Tilt
        options={{
          max: 45,
          scale: 1,
      ...
      >
        ...
        <div className="mt-5 flex-grow">
          ...
          <p className="mt-2 text-secondary text-[12px] flex-grow">
            {" "}
            {description}{" "}
          </p>
        </div>
...
const Works = () => {
  //  Keeps tracks of showing all projects
  const [showAllProjects, setShowAllProjects] = useState(false);

  // Toggles the showAllProjects state to true or false
  const toggleShowAllProjects = () => {
    console.log(showAllProjects);
    console.log("Toggle Projects was clicked");
  ...
  return (
    <div>
      <motion.div variants={textVariant()}>
        <p className={styles.sectionSubText}>Thing's I've Worked So Far...</p>
      ...
      <div className="w-full flex">
        ...
        >
          ...
          the code over on my GitHub, or live websites, with demos/screenshots.
          It reflects my ability to solve peoples problems, work with various
          tech stacks, collaborate with people, and manage projects efficiently.
        </motion.p>
      </div>
