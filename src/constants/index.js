...
const experiences = [
    {
        title: "Front Stack Software Engineer/Web Developer",
        company_name: "CSULA University Times",
        icon: utlogo,
        iconBg: "#383E56",
        date: "October 2019 - May 2023",
        points: [
            " Achieved an impressive decrease of over 40% in web application loading times through the strategic optimization of WordPress components using pure JavaScript," +
            ...
            "Successfully integrated Google AdSense on http://csulauniversitytimes.com, resulting in a remarkable 15% increase in profit compared to the previously employed static advertising approach.",
        ],
    },
    {
        title: "Software Engineer School Intern",
        ...
        points: [
            ...
            "Pioneered the development of a game-changing Unity Graphical User Interface (GUI) component for combat personnel, eliminating the need to view underlying code in real-time, optimizing user experience, and increasing operational efficiency by 40%.",
            "Meticulous Project Delivery for Sustainable Scalability: Ensured the successful completion of the project and meticulous attention, creating 100% new modern documentation.",
